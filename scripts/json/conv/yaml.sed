...
: init_holdspace
  ...
  /\x00$/ {
    z
    s/^/printf '%s:%s%sZ' "${SEDJUTSU_INDENT:-2}" "${SEDJUTSU_NOCOLOR+y:}" "${SEDJUTSU_COLORS:-0;90:0;39:0;39:0;39:0;32:1;39:1;39:1;34}"/
  }
  /\n$/ {
    z
    s/^/printf '%s:%s%s\n\n' "${SEDJUTSU_INDENT:-2}" "${SEDJUTSU_NOCOLOR+y:}" "${SEDJUTSU_COLORS:-0;90:0;39:0;39:0;39:0;32:1;39:1;39:1;34}"/
  }
  e
  /Z$/ {
    s/.$/\x00/
